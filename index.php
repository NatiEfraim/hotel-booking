...
// hotels table
try {
	// Define and execute a SQL query to select all hotels with "status" = 1
	$hotelsQuery = $conn->prepare("SELECT * FROM hotels WHERE status = 1");
	$hotelsQuery->execute();

	// Fetch all the matching rows as objects
	$allHotels = $hotelsQuery->fetchAll(PDO::FETCH_OBJ);

	// Check if any hotels were found
	if (count($allHotels) > 0) {
		// Loop through the retrieved hotels and display information
		...
		echo "No hotels found with status = 1.";
	}
	// // rooms table
	// Define and execute a SQL query to select all hotels with "status" = 1
	$roomsQuery = $conn->prepare("SELECT * FROM rooms WHERE status = 1");
	$roomsQuery->execute();
	...
	<div class="container">
		<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
			<div class="col-md-7 ftco-animate">
				...
				<p><a href="<?php echo APPURL ?>about.php" class="btn btn-primary">Learn more</a> <a href="#" class="btn btn-white">Contact us</a></p>
			</div>
		</div>
	</div>
</div>
				...
				<div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
					<div class="d-block services-wrap text-center">
						...
						<div class="media-body py-4 px-3">
							...
							<p><a href="./rooms/rooms.php?id=<?php echo $hotel->id; ?>" class="btn btn-primary">View rooms</a></p>
						</div>
					</div>
				</div>
			<?php endforeach; ?>
					...
					<div class="room-wrap d-md-flex">
						...
						<div class="half left-arrow d-flex align-items-center">
							<div class="text p-4 p-xl-5 text-center">
								...
								<!-- <p class="mb-0"><span class="price mr-1">$</span><span class="per">per night</span></p> -->
								<h3 class="mb-3"><a href="./rooms/rooms.php?id=<?php echo $room->hotel_id; ?>"><?php echo $room->name; ?></a></h3>
